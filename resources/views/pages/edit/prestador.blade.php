            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <form action="{{ route('atualizar_prestador', ['id' => $prestador->id]) }}" method="POST">
                            @csrf
                            @if (session('status2'))
                            ...
                            <div class="form-group ml-1">
                                ...
                                <input type="text" class="form-control" name="nome" value="{{$prestador->nome}}">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group ml-1">
                                ...
                                <input type="text" class="form-control" name="cnpj" placeholder="12.345.678/0001-00" onkeypress="$(cnpj).mask('00.000.000/0000-00')" value="{{$prestador->cnpj}}" >
                                <div class="invalid-feedback">
