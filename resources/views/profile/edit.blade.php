...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Essa é sua pagina de perfil. Você pode ver o seu progresso de trabalho e gerir seus projetos ou tarefas designadas'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                <img alt="Image placeholder" src="../assets/img/theme/team-5.jpg" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a href="#" class="btn btn-sm btn-info mr-4">{{ __('Conectar') }}</a>
                            <a href="#" class="btn btn-sm btn-default float-right">{{ __('Mensagem') }}</a>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Brasília, Brasil') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Desenvolvedor Web - PRÓEMPRESA') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('Faculdade Projecão') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('PróGestão — Sistema de gestão financeira PróEmpresa.') }}</p>
                            <a href="#">{{ __('Mostrar mais') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Informações do usuario') }}</h6>
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="{{ __('Confirme sua Senha') }}" value="" required>
                                </div>
